...
// import { ReactComponent as CollaboIcon } from "@/public/skill_collabo.svg";
    ...
    <SkillsWrapper className="grid grid-cols-2 gap-20">
      <div>
        <h2 className={Noto_Sans_KR_500.className}>
          다음과 같은 기술을 활용하여 멋진 웹 어플리케이션을 개발할 수 있습니다.
          Typescript와 React를 주력으로 사용하고 있습니다.{" "}
        </h2>
        <p className={Noto_Sans_KR_300.className}>
          Typescript와 javascript로 웹 어플리케이션을 개발할 수 있으며 주로 PC와
          모바일 디바이스를 대상으로 하는 서비스 개발을 할 수 있는 기술이
